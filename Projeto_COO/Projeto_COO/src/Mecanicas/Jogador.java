...
import java.awt.Color;
    ...
    public class Jogador extends Entidade implements Atirador, Colidivel, Movivel {
        ...
        public void update(long delta) {
            ...
            this.x = Math.max(0.0, Math.min(this.x, GameLib.WIDTH - radius));
            this.y = Math.max(25.0, Math.min(this.y, GameLib.HEIGHT - radius));
        }
